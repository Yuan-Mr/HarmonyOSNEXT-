...
![image](https://github.com/user-attachments/assets/f4410463-858d-42db-b0fe-19272be34b83)


从项目架构图我们可以看出来，未来我们IF画软件的功能是很多的，包括`分布式协同`、`拖拽流转`、`分享`、`音频导入`等等。一期我们先搭建整个基础框架以及`绘画功能`、`视频生成`功能。这些功能都来源我们鸿蒙的特性，从而才能实现。

![image](https://github.com/user-attachments/assets/3434f2ec-b9e3-4e34-bc6b-ba5095933d10)
...
![image](https://github.com/user-attachments/assets/c7b46e8a-ac2a-45b5-b64e-a235270a477a)
...
![image](https://github.com/user-attachments/assets/13c1efcb-8804-42f5-89d7-0ca15aa0d9aa)

![image](https://github.com/user-attachments/assets/724e900a-f590-4b49-b7e9-0db3535900de)
...
![image](https://github.com/user-attachments/assets/de9186a1-ab64-4365-9cee-a66b0a1bd0ff)
...
![image](https://github.com/user-attachments/assets/56ded3f1-afa9-4fae-b462-f24a26b6fc2a)
...
![image](https://github.com/user-attachments/assets/65200e27-bbb6-4809-aea0-d4e35bcf3c2e)
...
![image](https://github.com/user-attachments/assets/1ed21055-a031-4a1d-ae01-92456f3ad151)


![image](https://github.com/user-attachments/assets/f757dc19-2437-46a7-940d-0a27b806acbe)
...
![image](https://github.com/user-attachments/assets/321f84ef-3a38-4f0d-8f28-8e605ed5741d)


然后这里如果你要装第三方依赖或者云服务器相关的依赖，要在对应的云函数目录下安装，如果你在整个项目里面安装依赖的话，上传的时候，就会打不到依赖，云函数调用就会报错，所以要避免这点

![image](https://github.com/user-attachments/assets/ec695571-ce79-4419-ae0b-42778a86d4b6)
